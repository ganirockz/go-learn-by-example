...
func main() {
	...
	// if you uncomment below line, we will wait for 1 second and timer 2 will be fired in worker goroutine. timer2.stop() will give false since timer is fired before we stop.
